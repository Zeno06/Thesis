...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 06:04 AM
...
CREATE TABLE `payment_requests` (
  ...
  `request_type` enum('Repair','Parts','Other') NOT NULL,
...
INSERT INTO `payment_requests` (`request_id`, `acquisition_id`, `plate_number`, `vehicle_model`, `request_type`, `amount`, `description`, `status`, `requested_by`, `requested_at`, `approved_by`, `approved_at`) VALUES
(1, 2, 'ABC123', 'Toyota Vios', 'Repair', 10000.00, 'Repair the Hood and Suspension', 'Pending', 'Maria Reyes', '2025-11-11 04:54:17', NULL, NULL);
...
(10, 'sa.admin@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'superadmin', 'Admin', 'Super', 'active', '2025-10-15 08:54:32', '2025-11-11 04:54:43'),
(11, 'aq.cruz@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'acquisition', 'Cruz', 'Juan', 'active', '2025-10-15 08:54:32', '2025-11-11 04:48:31'),
(12, 'op.reyes@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'operation', 'Reyes', 'Maria', 'active', '2025-10-15 08:54:32', '2025-11-11 04:48:54');
...
CREATE TABLE `vehicle_sales` (
  ...
  `payment_terms` enum('Cash','Financing') NOT NULL,
  `financing_company` varchar(255) DEFAULT NULL,
  `agent_name` varchar(255) NOT NULL,
  `vehicle_released_pass_id` varchar(100) DEFAULT NULL,
  `remarks` text DEFAULT NULL,
...
INSERT INTO `vehicle_sales` (`sale_id`, `acquisition_id`, `date_sold`, `date_released`, `customer_name`, `plate_number`, `vehicle_make`, `vehicle_model`, `year_model`, `color`, `selling_price`, `total_cost`, `gross_profit`, `payment_terms`, `financing_company`, `agent_name`, `vehicle_released_pass_id`, `remarks`, `sold_by`, `created_at`) VALUES
(1, 2, '2025-11-07', '2025-11-09', 'Anthony', 'ABC123', 'Sedan', 'Toyota Vios', 2015, NULL, 370800.00, 609000.00, -238200.00, 'Cash', '', 'Mark', 'ABD234', 'Bad Sale', NULL, '2025-11-11 04:53:25');
...
--
ALTER TABLE `vehicle_acquisition`
  MODIFY `acquisition_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `payment_requests`
  ADD CONSTRAINT `payment_requests_ibfk_1` FOREIGN KEY (`acquisition_id`) REFERENCES `vehicle_acquisition` (`acquisition_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `vehicle_sales`
  ADD CONSTRAINT `vehicle_sales_ibfk_1` FOREIGN KEY (`acquisition_id`) REFERENCES `vehicle_acquisition` (`acquisition_id`) ON DELETE CASCADE;
COMMIT;
