...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2025 at 06:02 AM
...
--
-- Table structure for table `approved_acquisitions_tracking`
--

CREATE TABLE `approved_acquisitions_tracking` (
...
--
-- Table structure for table `quality_check_tracking`
--

CREATE TABLE `quality_check_tracking` (
...
(1, 'sa.admin@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'superadmin', 'Admin', 'Super', 'active', '2025-11-26 08:46:28', '2025-11-26 20:00:50'),
(2, 'aq.cruz@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'acquisition', 'Cruz', 'Juan', 'active', '2025-11-26 08:46:28', '2025-11-26 20:00:41'),
(3, 'op.reyes@carmax.com', '$2y$10$lmcVdwlCSRFOa.OKCRtSp./Vvf1j9Nyo3O832/g6z87SalnaOpH32', 'operation', 'Reyes', 'Maria', 'active', '2025-11-26 08:46:28', '2025-11-26 12:39:47');
...
--
-- Indexes for table `approved_acquisitions_tracking`
--
ALTER TABLE `approved_acquisitions_tracking`
  ADD PRIMARY KEY (`approval_id`),
  ADD KEY `acquisition_id` (`acquisition_id`);

--
-- Indexes for table `quality_check_tracking`
--
ALTER TABLE `quality_check_tracking`
...
--
-- AUTO_INCREMENT for table `approved_acquisitions_tracking`
--
ALTER TABLE `approved_acquisitions_tracking`
  MODIFY `approval_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `quality_check_tracking`
--
ALTER TABLE `quality_check_tracking`
...
--
-- Constraints for table `approved_acquisitions_tracking`
--
ALTER TABLE `approved_acquisitions_tracking`
  ADD CONSTRAINT `approved_acquisitions_tracking_ibfk_1` FOREIGN KEY (`acquisition_id`) REFERENCES `vehicle_acquisition` (`acquisition_id`) ON DELETE CASCADE;

--
-- Constraints for table `quality_check_tracking`
--
ALTER TABLE `quality_check_tracking`
  ADD CONSTRAINT `quality_check_tracking_ibfk_1` FOREIGN KEY (`acquisition_id`) REFERENCES `vehicle_acquisition` (`acquisition_id`) ON DELETE CASCADE;
